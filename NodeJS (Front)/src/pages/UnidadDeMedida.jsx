...
function UnidadDeMedida() {
  ...
  const cargar = async (nombre = filtroNombre, abreviacion = filtroAbreviacion) => {
    try {
      const res = verActivas
        ? await unidadDeMedidaService.buscarActivas(nombre || null, abreviacion || null)
        : await unidadDeMedidaService.buscarInactivas(nombre || null, abreviacion || null)
  ...
  return (
    <div className="-m-6 min-h-screen bg-[#eaf2fb] p-8 text-slate-900">
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-5 mb-7">
        <div>
          <h1 className="text-4xl font-bold tracking-tight border-l-2 border-slate-800 pl-2">Unidades</h1>
          <p className="text-sm text-slate-500 mt-2">Control de unidades de medida para venta</p>
        </div>
      ...
      <div className="flex flex-wrap gap-3 mb-7">
        ...
        />
        <input
          placeholder="Buscar por abreviacion"
        ...
        <table className="w-full min-w-[860px] text-sm">
          <thead className="text-slate-800 border-b border-slate-400">
            <tr>
              ...
              <th className="py-4 px-3 text-left font-bold">Abreviacion</th>
      ...
      {modalAbierto && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-[#eaf2fb] rounded-md shadow-2xl w-full max-w-xl min-h-[500px] relative p-9">
            <button
            ...
            <h2 className="text-3xl font-bold uppercase mb-9">
              {editando ? 'Editar unidad' : 'Registrar nueva unidad'}
            </h2>
            ...
            <div className="space-y-5">
              ...
              <div>
                <label className="text-slate-400 text-lg">abreviacion</label>
                <input
